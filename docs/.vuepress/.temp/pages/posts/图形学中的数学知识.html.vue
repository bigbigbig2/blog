...
<p><img src="https://img-blog.csdnimg.cn/img_convert/8b211a0124a1614c694585ee0cfc8476.png" alt="image-20220325183104982"></p>
<blockquote>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/f5f4070d3e9776edcb48caaa5219d96c.png" alt="image-20220325184702129"></p>
...
<p>可以看成是在空间中的平移平行</p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/6133f693da62b0732d2cf7afa98f9d3f.png" alt="image-20220429220537199"></p>
<p>也可以看出数轴上加法的一种扩展（运算上）</p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/2e17925124c54be5d9cc7f9dbd76fc76.png" alt="image-20220513161809457"></p>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/3e635d461d1874a666e7f844c633d9f2.png" alt="image-20220429221350283"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p><img src="https://img-blog.csdnimg.cn/img_convert/88d2ee2c340c7841f447538718f9cf29.png" alt="image-20220325193858100"></p>
<p>两种特殊情况：</p>
<ul>
<li>
...
<p>投影为垂直投影</p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/f716e2f67f4ae8e4f2453472f7c96230.png" alt="image-20220513164856675"></p>
<blockquote>
<ul>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/e19eca562b90e4bf609c8c00ef118422.gif" alt="img"></p>
<blockquote>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/35d91c7f5ff801ee21038d57c2451d83.gif" alt="a"></p>
<ul>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/9964c446cedc250d5d868bf7c59a944d.png" alt="image-20200922122052167"></p>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/9f2d600641cf3fed5780abe9b516cc58.png" alt="image-20220325194757338"></p>
...
<p>确定叉积的方向：</p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/ba88d5eac3686612a1ddb73329cf6fa1.png" alt="image-20220513170113777"></p>
...
<p>圆的参数方程</p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/b032fdf5c6393cb18457c164310f5e5f.png" alt="img"></p>
<p>图形绘制代码</p>
...
<p>椭圆方程：</p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/17caec5be04ccd323f29656b2b4ddd76.png" alt="img"></p>
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">const</span> <span class="token constant">TAU_SEGMENTS</span> <span class="token operator">=</span> <span class="token number">60</span><span class="token punctuation">;</span>
<span class="token keyword">const</span> <span class="token constant">TAU</span> <span class="token operator">=</span> Math<span class="token punctuation">.</span><span class="token constant">PI</span> <span class="token operator">*</span> <span class="token number">2</span><span class="token punctuation">;</span>
...
<p>抛物线方程：</p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/d14298b08b75aace8280ff027af78ed1.png" alt="img"></p>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/2d14f1b3e225292fb2661d7750b16bb7.png" alt="img"></p>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/4424f05676101b1977149c433144d48e.png" alt="img"></p>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/0cf1311e4c0e144183a09432a40128b4.png" alt="img"></p>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/45f9159fd0dbf792509c1d57ae729309.png" alt="img"></p>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/d0e7d17369d059a48f7a65bbe6c34291.png" alt="img"></p>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/e8cb1f464e5cd9717839a2e55298c8d9.png" alt="image-20220504103852714"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br><span class="line-number">14</span><br><span class="line-number">15</span><br><span class="line-number">16</span><br></div></div><p><img src="https://img-blog.csdnimg.cn/img_convert/e880261c98a9e1b8f976ebb242513fd3.gif" alt="img"></p>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/f8368ae6c79cb0d8542f74d409c320d0.png" alt="image-20220430102957056"></p>
<blockquote>
<p>变换和函数又有所不同，因为使用变换是在以特定的方式来可视化这一输入——输出的关系</p>
<p>一种理解“向量函数”的方法是使用运动</p>
</blockquote>
<p>例如一个变换接收一个向量并输出一个向量，我们可以想象这个输入向量移动到输出向量的位置</p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/15a7b79e089b3451ebd9bf8db32469e0.png" alt="image-20220430103406207"></p>
<p>线性代数限制在一种特殊类型的变换上，称为“线性变换”，这种变换更容易理解</p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/7bf5d48a683e94df863e678fda9c13d5.png" alt="image-20220430103648763"></p>
...
<p>示例：</p>
<p>保持网格平行且等距分布的变换</p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/42f0fb8a61a53aaecbcb00a7a6be1e89.gif" alt="a"></p>
<p>根据原点旋转</p>
<p><img src="https://img-blog.csdnimg.cn/d691f69acaeb41d6a1469c4ae9f00a5b.png" alt="在这里插入图片描述"></p>
<blockquote>
<p>更多详见线性代数的本质文章</p>
</blockquote>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/4f20f2d7d492f0dece2602f772ac7db8.png" alt="image-20220430112007200"></p>
...
<div class="language-javascript ext-js line-numbers-mode"><pre v-pre class="language-javascript"><code><span class="token keyword">class</span> <span class="token class-name">Vector2D</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br><span class="line-number">10</span><br><span class="line-number">11</span><br><span class="line-number">12</span><br><span class="line-number">13</span><br></div></div><p><img src="https://img-blog.csdnimg.cn/img_convert/f7fde4320b125cbe62f5871828cffdb1.png" alt="img"></p>
<p>假设向量 <code>P</code> 的长度为 <code>r</code>，角度是<code>⍺</code>，现在我们要将它逆时针旋转<code>⍬</code>角，此时新的向量<code>P’</code>的参数方程为：</p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/1548e51b13ded3090c3c17367c96a16c.png" alt="img"></p>
<p>然后，因为 <code>rcos⍺</code>、<code>rsin⍺</code>是向量 <code>P</code> 原始的坐标 <code>x0</code>、<code>y0</code>，所以，我们可以把坐标代入到上面的公式中，就会得到如下的公式：</p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/0c1fab8bf22fe35a2d96483332f2d2cd.png" alt="img"></p>
<p>最后，我们再将它写成矩阵形式，就会得到一个旋转矩阵。（同时可以利用几何意义来理解：脑补）</p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/c85304e602d17ec0794351d73fc7626e.png" alt="image-20220504111937100"></p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/32c0c52940cd4ac71c095a6c99d8e800.gif" alt="a-16512881750802"></p>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/c4c93fd52fd93dc75cce15d7a3f9057d.png" alt="img"></p>
<p>几何理解</p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/264629de91449eb949693304ac99142d.png" alt="image-20220504112429227"></p>
<p>对于得到的这个公式，我们也可以把它写成矩阵形式。结果如下：</p>
<p><img src="https://img-blog.csdnimg.cn/img_convert/c9c52e648402833aedfb5c0d677c612a.png" alt="img"></p>
<blockquote>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/6c6dc77388a88a1af68c1bc933bfc753.png" alt="img"></p>
...
<p><img src="https://img-blog.csdnimg.cn/a6dddc7b162840098591d25bd6ecaa1c.png" alt="在这里插入图片描述"></p>
<blockquote>
<p>直线弯曲了，不是线性变换</p>
</blockquote>
<p><img src="https://img-blog.csdnimg.cn/img_convert/21c2a99026271019572b6413376cc427.gif" alt="a"></p>
<blockquote>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/9dd1f364851a2b805d664a68ac451305.png" alt="img"></p>
<blockquote>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/ef94e4b52811158a81fec6a5c6f06f72.png" alt="img"></p>
</blockquote>
...
<p><img src="https://img-blog.csdnimg.cn/img_convert/acce0a8991d989cb8f335236d2f3b8ba.png" alt="img"></p>
<blockquote>
