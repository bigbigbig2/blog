...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b29c845d3336471d983731ddd9e60332~tplv-k3u1fbpfcp-zoom-1.image" alt="image-20220324104101520"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/64c81f09bd414b42b6318c51302e1767~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br></div></div><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d05c4ea3e2ca4eb8a140388055ce95c3~tplv-k3u1fbpfcp-zoom-1.image" alt="image-20220324105040888"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/93ab23149c54419da05caa9f35df168a~tplv-k3u1fbpfcp-zoom-1.image" alt="image-20220419200624584"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ae2a6aa4a0fd431183dd4880ac380fe0~tplv-k3u1fbpfcp-zoom-1.image" alt="image-20220324110435465"></p>
<ul>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5ffda1284b044840bd0ee1ac74a07d24~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<p>重定向后发出的请求:</p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c3397e434193420eb8389808eaadc2bd~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<blockquote>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0d8178142e3f46e9af1c7da6f9327b14~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p>当渲染进程确认提交后：</p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d9209b43aa80438c98ada30a8cf40c7a~tplv-k3u1fbpfcp-zoom-1.image" alt="image-20220325100657654"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ceb7fec357024c5390edfbfb4161fe2c~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<p>由于渲染机制过于复杂，所以渲染模块在执行过程中会被划分为很多子阶段，输入的 HTML 经过这些子阶段，最后输出像素。我们把这样的一个处理流程叫做渲染流水线，其大致流程如下图所示：</p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3354b50b0c58414283454d064426570a~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/206851b4dfbf49e182b37e3ee97782f3~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<blockquote>
...
</code></pre><div class="line-numbers" aria-hidden="true"><span class="line-number">1</span><br><span class="line-number">2</span><br></div></div><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/980851a3a0534e3f969d32bbeab25e09~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/158ad948e305492b8bba74786322e32a~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<blockquote>
<p>样式源：</p>
</blockquote>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9197720a1a34421f8ef29ba2c5a8874b~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/96777c3c96e24be1a33906f68ecad125~tplv-k3u1fbpfcp-zoom-1.image" alt="image-20220419203357376"></p>
...
<p>通过浏览器开发者工具查看继承：</p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/fb9d043bcee74c959bb1b54007bc4530~tplv-k3u1fbpfcp-zoom-1.image" alt="image-20220325104843212"></p>
<ul>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c7c2291452ea42f1aa297853f04c6e59~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<blockquote>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/49f8dd137671462b927df52ad1f41b09~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<blockquote>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0b16ac80bc3a4c4fb409dc4dc6818368~tplv-k3u1fbpfcp-zoom-1.image" alt="image-20220325221406426"></p>
<blockquote>
<p>图层和布局树节点之间的关系</p>
</blockquote>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8d9a0f7f511a43b7939b1ed4ab01f586~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<blockquote>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5ff65613469d4014808076781d7ed46b~tplv-k3u1fbpfcp-zoom-1.image" alt="image-20220326100149857"></p>
<p>查看绘制过程</p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a8a8c8d631c54a3e84af83fc808020ab~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9ce51b28a6634ea3b73f1ba0e0676f08~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f391cd3bfa6f4f7fa6f7dc2eb059cade~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0655ec60fdea4f1183d2a446f82d5bf9~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<blockquote>
<p>合成线程提交图块给栅格化线程池</p>
</blockquote>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/cd5d4177cd044e40b061350fee6f650c~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/bc2db72555aa4092bc014fe9f52de357~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<ol>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5bf13622fa934230bd8143cc108d7021~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2c2b67ca63db47d6b3ce8c4fe607b451~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/973a0357236547089d5878f691f21ad3~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
