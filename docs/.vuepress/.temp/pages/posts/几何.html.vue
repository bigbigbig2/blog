...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/39b9b379ade0428eaa69efddacc88344~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/106503e50b7f4556b4e35ae0ea227d51~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/649237e134784785813bb5031814b368~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<p>显然可以发现，有些任务使用隐式表示很困难</p>
<p>但是，它也有它的优点：例如判断一个点在不在一个面上（或者判断某个顶于某个几何的关系）</p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/5391eb723015483cb33f084ac9d3d24c~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4ba488dd91b04facb3049b38979be075~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9281d21f99224f7dabf42d16ec8b1c5b~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d629ed59e29c423e968fa9320a1225ec~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<blockquote>
<p>例如上面的过程：将上面的两个球的距离函数计算出来，然后对这两个距离函数做一个Blending(融合)，然后在把它恢复成原来的物体（就是距离函数都返回0时的点）</p>
</blockquote>
<p>An Example：混合（线性插入）移动边界</p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/926fed7af8b64ebe8903245bc149ce15~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/84cf1fe2d5904c67bb23dce6beedf63b~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<ul>
<li>其实和等高线一个原理。。。。。</li>
<li>其实和距离函数类似，其实就它函数的表达形式不同而已</li>
</ul>
<p>水平集在医疗上的应用（三维）：恒定的组织密度</p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/bc59d5cd4920458d959a679983e60718~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<p>物理模拟中的水平集：
<img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/aa1a7770b7694e4884e19892ed6297e2~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0d9af24f2a4f4a0fbc0b42dde0609ad0~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3f77f339b9674c7294e69c90aa5e67d0~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6c148a6cf3894d769d80e75831caded9~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<ul>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/05ce9fa8cbfa4d468a1119e8f3f51770~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<ul>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8b5c769f92cf442db1b3bf6d402f5927~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/70ee7e1a9f9f41a6a11bdb7df75a7491~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<ul>
...
<img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/2a6a1e281e214bffad10f8a7d6f4fe93~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<p>详见另一篇文章</p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/939e258a0b224e1f9122a7e8d89b9ec5~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<h3 id="_1-bezier表面" tabindex="-1"><a class="header-anchor" href="#_1-bezier表面" aria-hidden="true">#</a> [1]Bezier表面</h3>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8f0a8054038e4c4c8b14d41d3fd30a70~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/66a650359cfa454b82b646a1be88e1c7~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0ac3c9de85ed4599bcb5a3c106477693~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<ul>
<li>首先确定一个参数，这样可以获得4个点</li>
<li>然后在确定另外一个参数v，这样就可以确定处曲面上具体的点了</li>
</ul>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/bee9e2db786b4a8c800daaa49865a68b~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<blockquote>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3c89378c090248b38279c492da73b4a7~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<ul>
...
<img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1cd701dcad9e4d17a05322ca4c1c65d7~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<p>三角形网格的一般细分规则：</p>
<ul>
...
<li>
<p>把每个三角形分成四个
<img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7680c0f1fe6f46289b4c40dd57e8c7cd~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
</li>
<li>
<p>调整新/旧顶点的位置来让这个模型变得光滑（新顶点/旧顶点的更新方式/算法不同）</p>
</li>
</ul>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9f6b35a60a5b48c8b938eaa496376b7e~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<p>对于新的顶点的更新位置：</p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/f6856115acba47e6b73b2a053a53f0c1~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<ul>
<li>例如白点为新顶点</li>
<li>将其位置跟新至$3/8 * (A + B) + 1/8 * (C + D) $以使其更平滑（加权平均）</li>
</ul>
<p>对于旧顶点的更新：</p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/11679ae768bd4527866437ba60433fe1~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<ul>
...
<p>例如：loop 细分的效果</p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6115da2e632a4b24b0e78ebda134f34c~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<blockquote>
<p>总结：先细分，在调整</p>
</blockquote>
...
<img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4dffbad796ac4f38855d6990f4ac240b~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<p>细分后：</p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/995a421f3be04d46bd1799dfba700d78~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4682e0ed961e4d8191e486c034fc2b34~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
</blockquote>
<p><strong>catmull-clark顶点更新规则（Quad网格）</strong></p>
<ul>
<li>将物体表面上的点细分为三类</li>
</ul>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/dbb7473ee99f44ec8c58b58a01e31840~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<ul>
<li>Face point（在面中间的新点）</li>
<li>Edge point（边的中间的点）</li>
<li>Vertex point（老的点）</li>
</ul>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/79153e21b5bb43ea95e1a0336307b25d~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c5123ea58af942d0a59fd627f6ee0cf1~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/071fd9d089af462d88c4f3d44f37cf04~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0293539b176c48e2aa8bbfc943207c25~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/85b4e7fd928a4c1face010335011f79e~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a9604f9431ae4a168c4549703d6a1347~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/39ae3b908b0b4befa1b7d1d28c8869b2~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8ce87810b5544e76b10adc584902c798~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<ul>
<li>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/0d8b5c51de5d4e10a9924158286abacc~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<h3 id="example" tabindex="-1"><a class="header-anchor" href="#example" aria-hidden="true">#</a> example：</h3>
<p>看一个实际案例（shadow mapping实现）</p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/41c5cbf7363545e2a95af77cec05eb9d~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<p>先从点光源方向开始（生成深度图）</p>
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/26139477a6cf4ec6ba45232c24f5f62d~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
<p>然后比对（这里并不是简单的比较是否相等，其实还包含很多问题需要处理：例如浮点数精度问题等）
<img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/52bfc59e8e704e38a9773dd36f3a0964~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
...
<p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ddf7f219e84f4b97b8623da81ef7e7ec~tplv-k3u1fbpfcp-zoom-1.image" alt="在这里插入图片描述"></p>
</template>
