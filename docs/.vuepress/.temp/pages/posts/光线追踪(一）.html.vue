<template><nav class="table-of-contents"><ul><li><RouterLink to="#_1-为什么要光线追踪">1.为什么要光线追踪</RouterLink></li><li><RouterLink to="#_2-基础的光线追踪算法">2.基础的光线追踪算法</RouterLink><ul><li><RouterLink to="#_1-ray-casting-光线投射">[1]Ray Casting（光线投射）</RouterLink></li><li><RouterLink to="#_2-whitted-style-递归光线追踪">[2]Whitted-Style 递归光线追踪</RouterLink></li></ul></li><li><RouterLink to="#_3-光线与平面交点">３.光线与平面交点</RouterLink><ul><li><RouterLink to="#_1-光线方程及应用">[1]光线方程及应用</RouterLink></li><li><RouterLink to="#_2-光线和隐式表面的求交">[2]光线和隐式表面的求交</RouterLink></li><li><RouterLink to="#_3-光线和显式表面的求交">[3]光线和显式表面的求交</RouterLink><ul><li><RouterLink to="#光线与三角形求交">光线与三角形求交</RouterLink></li><li><RouterLink to="#moller-trumbore算法">Möller Trumbore算法</RouterLink></li></ul></li><li><RouterLink to="#_4-box包围盒">[4]Box包围盒</RouterLink><ul><li><RouterLink to="#光线与二维包围盒求交">光线与二维包围盒求交</RouterLink></li><li><RouterLink to="#为什么要使用轴对齐">为什么要使用轴对齐？</RouterLink></li></ul></li></ul></li><li><RouterLink to="#_4-using-aabbs-to-accelerate-ray-tracing">4.Using AABBs to accelerate ray tracing</RouterLink><ul><li><RouterLink to="#_1-uniform-spatial-partitions-grids-统一空间分区">[1]Uniform Spatial Partitions (Grids)统一空间分区</RouterLink></li><li><RouterLink to="#_2-spatial-partitions空间划分">[2]Spatial Partitions空间划分</RouterLink><ul><li><RouterLink to="#kd-tree">KD-tree</RouterLink></li></ul></li><li><RouterLink to="#_3-bvh-对象划分">[3]BVH &amp; 对象划分</RouterLink></li></ul></li></ul></nav>
<h2 id="_1-为什么要光线追踪" tabindex="-1"><a class="header-anchor" href="#_1-为什么要光线追踪" aria-hidden="true">#</a> 1.为什么要光线追踪</h2>
<ul>
