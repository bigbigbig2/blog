...
![在这里插入图片描述](https://img-blog.csdnimg.cn/be75cf19cc13446c97f56baa16698b83.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/c490069df20b4a9aa1834d3fab59169a.png)


### [2]Glossy material (BRDF)光泽材质

![在这里插入图片描述](https://img-blog.csdnimg.cn/3bd30d42eea7484da565f08d6feca55d.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/c8146ab107fc4f09a308deb59e0e655a.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/1dc034a746dd4de6b2f33b1f079d3015.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/d82ab62d618945d3b47f5c9f1f5e9bab.png)


Snell’s Law折射定律：

![在这里插入图片描述](https://img-blog.csdnimg.cn/214739d9ff4a4231875029983dfdf8fd.png)


不同的材质有不同的折射率$n$，这样给定入射光和角度就很容易计算出折射角了

![在这里插入图片描述](https://img-blog.csdnimg.cn/e799cf52c4af4c0299a2306ca337face.png)


也就是说不能再折射率大的地方看到折射率小的地方，例如Snell’s Window / Circle

![在这里插入图片描述](https://img-blog.csdnimg.cn/b63cf7906a5042549f7801dcf9e928c5.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/d9b2ad4dd9344954a1cdfaf7aefcd880.png)


下图为对某个折射率为1.5的**绝缘体**的菲涅尔项数据。正常情况为实线，角度与反射的情况（虚线为光的极化性质，光只沿着S或者P的方向振动的时候，一般不考虑）

![在这里插入图片描述](https://img-blog.csdnimg.cn/b731dfe39a1844d1a2bfd7cde03b971b.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/33c47e42b47344c0b80ea79f13a6fc08.png)


菲涅耳项的计算公式如下：

我们需要计算入射角为  时的反射率，但是菲涅耳项不好算
![在这里插入图片描述](https://img-blog.csdnimg.cn/349aa311a7a8401689d9865da62a0c93.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/b9e78a89f69a4c609bb0ab90c9e91086.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/7901d9109b2f4a46a57aa91c905e0ed1.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/ffadff33450449b196f305254c7bb267.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/cbed5bcbfd0b43b1a3f73adc64068992.png)


- Isotropic各向同性，微表面并不存在一定的方向性(法线分布均匀)
- Anisotropic各向异性，微表面存在方向性

![在这里插入图片描述](https://img-blog.csdnimg.cn/1bfc17e504a941378cd7fe57c63d9f5e.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/5c275ecbeb28415bb8ecb54dae7c8e59.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/83707be448114c628a4d95ad0bc392b1.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/96b0e7a7da4b4215b5ca32aad36059e7.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/e85ac795619a4de69efa5ebf74396ff3.png)


测量BRDF：GonioreReTectometer

![在这里插入图片描述](https://img-blog.csdnimg.cn/750f18ae5ade46469df892b87aa7af7a.png)
