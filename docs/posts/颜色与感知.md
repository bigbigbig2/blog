...
![在这里插入图片描述](https://img-blog.csdnimg.cn/ab481c3c2b6d416aa8f393d2b1494806.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/2f5c55337da64375a2ffa697194eb156.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/04360f9b689f439e9b7ce1affceb23a7.png)


![在这里插入图片描述](https://img-blog.csdnimg.cn/676b51b05072415ca5463a4b5eef4e5b.png)


多种光混合之后的SPD等于单个光对应得SPD相加，如下图所示

![在这里插入图片描述](https://img-blog.csdnimg.cn/154a7fc2b15f4477a1ea763410e564cc.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/a77d1777d14644bdab946283dec28b3f.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/103429f258014ee39a6999c0bd357ce0.png)
...
三种细胞对不同波长的响应各不相同
![在这里插入图片描述](https://img-blog.csdnimg.cn/f2d687de00bc453db19e392c886ef710.png)


不同的人的这三种细胞的分布和数量差异很大，下面这幅图展示的是12个正常视力的人的三种锥形细胞分布情况

![在这里插入图片描述](https://img-blog.csdnimg.cn/1a9c3c9d1e3a4001bb5f2f2eaffcac9b.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/341d1b543d7b40ab83326bd981597b54.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/a3677d73d28247b194f32c28e44cc5ed.png)


## 3.同色异普

根据上面的色彩三色理论可以推想到，尽管两种光线不同光谱，但经过上述积分后，得到的SML是相同的，那么人们看到的颜色是相同的。（还可以出同一物体每个人看到的是不一样的），如下图尽管它们的SPD不同，但是它们最终显示的颜色还是一样的。
![在这里插入图片描述](https://img-blog.csdnimg.cn/d5dfe3f1ed9642789c95ae7fc5d7816f.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/2882508385e9464e9321022c600d1a43.png)


加色系统：

![在这里插入图片描述](https://img-blog.csdnimg.cn/e32ff01c8fe44bb5b05f0a84598e83bd.png)


通过将一些颜色混合可以调处别的颜色。但有些颜色怎么也混合不出，通过给这些颜色加色就可以混合出，即将最后混合的颜色减去加上的颜色，就可以混合出该颜色。因此有些颜色的取值是负的。

![在这里插入图片描述](https://img-blog.csdnimg.cn/0978ba9c1583465eb999a8269a8125d4.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/a16cb44e37814e198b6fab6bc5ef3952.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/f09d8dda7b4d4e44b84d9c78bd000f31.png)


但是RGB并不能表示人眼所能见到的所有颜色
![在这里插入图片描述](https://img-blog.csdnimg.cn/28c5ebb825f7460bb52d643bdfcdd27f.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/3a17168ab99b45d2abd769ab7a186b55.png)


- Y表示亮度，没有负数
- 将$(X,Y,Z)$归一化，然后对（x，y）进行枚举，得到一张二维图像，表示在Y（亮度）固定的情况下，不同XZ对应的颜色。色域是一个颜色空间所有可能显示的颜色，下图右边就是色域。

![在这里插入图片描述](https://img-blog.csdnimg.cn/94c93bd1c98d4895b89e95d79b0e4704.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/20dd9a6ce5a74b5f8690df35d2005c7b.png)
...
### [1]HSV/HSL颜色空间
![在这里插入图片描述](https://img-blog.csdnimg.cn/b997f538df7744b1b8e1bd67b9331b5d.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/310e134d607f4a83a1f400a1ebd417c4.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/37ac028cc77843aa8f46e33f948a6ef0.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/eff02bdf10a04fb7a649be20a95be2e3.png)
...
还有一个有以上的视觉感知现象——错视觉
![在这里插入图片描述](https://img-blog.csdnimg.cn/46d5c6ec609d4bbdab46bee34ecdf3af.png)
![在这里插入图片描述](https://img-blog.csdnimg.cn/451420124b4a4a5bb34807c98d21ea40.png)
...
![在这里插入图片描述](https://img-blog.csdnimg.cn/fd1c9034d9ab4ac4a7fc170e15c73a48.png)
