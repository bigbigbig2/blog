...
![image-20220417221609580](https://img-blog.csdnimg.cn/img_convert/5f2f61ebf23b25a35c7c5d6f8279c392.png)

### [6]空间数据类型

一个普通的数据库有字符串、数字和日期。而空间数据库添加了额外的数据类型来表示**地理特征**。这些数据类型抽象和封装了`边界`和`维度`等空间结构。在许多方面，空间数据类型可以简单地理解为形状geometry。

![image-20220417221758072](https://img-blog.csdnimg.cn/img_convert/52fad039ffae666693d3c490ae3999ba.png)
...
![preview](https://img-blog.csdnimg.cn/img_convert/effab061ff8026380d71ef1233aa9346.png)

**SQL/MM的Geometry类型结构图：**

![preview](https://img-blog.csdnimg.cn/img_convert/d83a5a080622529c49d94ccd84ccc7c8.png)

![preview](https://img-blog.csdnimg.cn/img_convert/a4cef99fe48ce7a3bd366219230be6b4.png)
...
![image-20220417222654664](https://img-blog.csdnimg.cn/img_convert/49524bc114fe6fb96969832f3e580805.png)
...
![image-20220417222955532](https://img-blog.csdnimg.cn/img_convert/fa9d8a146c3ba44916c43a1145aaa7ad.png)

![image-20220417223008940](https://img-blog.csdnimg.cn/img_convert/036791f4c54e402f662bbbaff919cbed.png)
...
![image-20220329155928476](https://img-blog.csdnimg.cn/img_convert/e6d7f8b6aff6cd5b16a0a16fe9997a8f.png)
...
![image-20220417223455283](https://img-blog.csdnimg.cn/img_convert/dceb1e0735b2345399229702731df209.png)
...
- 交叠(`overlaps`)
  ...
  ![image-20220329182701564](https://img-blog.csdnimg.cn/img_convert/42bb9290ded7e585ac5fd0bab9c27e18.png)

- 包含于(`within`)
  若𝑎 ∩ 𝑏 = 𝑎，且I 𝑎 ∩ 𝐸 𝑏 = ∅，则a包含于b内

  ![image-20220417223933200](https://img-blog.csdnimg.cn/img_convert/acf68b1618f3f415f9f99fffc31041d9.png)
...
- 相接(`touches`)
  ...
  但没有点/点相接关系(为什么?)
		...
		![image-20220417223914721](https://img-blog.csdnimg.cn/img_convert/51c102da4ce838bd512b59f3759a8ab9.png)
...
- 穿越(`crosses`)
  ...
  n 点/线、点/面、线/线、线/面穿越关系
		...
		![image-20220329182843549](https://img-blog.csdnimg.cn/img_convert/9f27cf24b5747a2ca28f6a2f164f2cb5.png)

空间对象的拓扑关系不是非此即彼的，也有一定的分辨精度层次关系

![image-20220417223830724](https://img-blog.csdnimg.cn/img_convert/65a89d72bca8861e1f9c733e49eb0c18.png)

#### 逻辑模型

基于概念模型，OGC提出了基于预定义数据类型和基于扩展几何类型的两种实现方法

![image-20220329183442285](https://img-blog.csdnimg.cn/img_convert/9d817f0c02a41486ff2de4875c09a287.png)
...
![image-20220417224138876](https://img-blog.csdnimg.cn/img_convert/a868cd0502d0dae0019c644898dd3a21.png)
...
![image-20220329185824973](https://img-blog.csdnimg.cn/img_convert/f51adb9599f571bd64b59968632fa60d.png)
...
